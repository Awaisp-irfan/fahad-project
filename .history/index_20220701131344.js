...
// design variable 
let designCreation = document.getElementById('designCreation')
let checkFile = document.getElementById('checkFile')
// shipping variable 
...
designCreation.addEventListener('click' , updateSelection7)
checkFile.addEventListener('click' ,updateSelection8 )
// shiping method
...
function result(){
    ...
    var add = productPrice
            ...
            if (shippingPrice.value == "germany"  && country1 === 54){
               add = add + country1
            }
            else if (shippingPrice.value == "germany"  && country1 === 19) {
                add = add + country1
            }
            else{}

            if (shippingPrice.value == "europe"  && country2 === 115){
                add = add + country2
             }
             else if (shippingPrice.value == "europe"  && country2 === 39){
                 add = add + country2
             }
             else{
             ...
             if (shippingPrice.value == "uk"  && country3 === 115){
                add = add + country3
             }
             else if (shippingPrice.value == "uk"  && country3 === 60){
                 add = add + country3   
             }
             else{
